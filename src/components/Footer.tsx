  ...
  return (
    <footer className="bg-zinc-800 border-t border-zinc-700 p-4 flex items-center justify-between">
      <div className="flex items-center gap-3">
        <Image src="/playlist6.jpg" width={64} height={64} alt="Mix dance/Eletrônica" />
        <div className="flex flex-col">
          <strong className="font-normal">Survive</strong>
          <span className="text-xs text-zinc-400">M!R!M</span>
        </div>
      </div>
